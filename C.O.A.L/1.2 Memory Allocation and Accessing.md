...
main PROC
	...
	; We had to derefernce both 2 times because they are pointers to pointers (double pointers)
...
This is what's happening in MASM code. When it dereferences once we go from &arr to arr basica
