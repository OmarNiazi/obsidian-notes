...
- For a perfect binary tree of height ![](data:,):
    
    - The total number of nodes is exactly ![](data:,).
        
    - The number of leaf nodes is ![](data:,).
...
- **Perfect** ![](data:,) **Complete** ![](data:,) **Not necessarily Full**
    
- **Perfect** ![](data:,) **Full** ![](data:,) **Not necessarily Complete**
