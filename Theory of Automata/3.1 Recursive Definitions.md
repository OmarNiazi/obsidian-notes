...
1) First, we specify some basic objects in the set. This is known as the **Base Case**. 
...
The book delves into why this process of defining a set is unpopular; it is hard and lengthy to prove, as you can read [[Introduction To Computer Theory.pdf#page=35|here]]. 
